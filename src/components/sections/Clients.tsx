        ...
        <section className="py-20 bg-white dark:bg-navy border-y border-slate-100 dark:border-slate-900 overflow-hidden relative">
            <div className="section-container relative z-10">
                <div className="text-center mb-12">
                    <h2 className="text-xs font-bold uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400 mb-2">
                    ...
                    {clients.map((client) => (
                        ...
                        >
                            <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/30 group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-500">
                                <client.icon size={28} className="text-slate-500 dark:text-slate-400 group-hover:text-primary transition-colors" />
                            </div>
                            <span className="text-2xl font-heading font-black tracking-tighter text-slate-500 dark:text-slate-400 group-hover:text-navy dark:group-hover:text-white transition-colors">
                                {client.name}
                            </span>
                        </div>
                    ))}
