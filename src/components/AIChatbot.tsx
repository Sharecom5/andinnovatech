            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="mb-4 w-[380px] md:w-[420px] max-h-[600px] h-[80vh] bg-white dark:bg-navy rounded-[2.5rem] shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col"
                    >
                        {/* Header */}
