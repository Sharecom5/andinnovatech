...
export default function SaaS_Login() {
  ...
  async function handleEmailLogin(e: React.FormEvent) {
    ...
    try {
      ...
      router.push('/Event-pass-generator/admin') // Redirect to dashboard
      router.refresh()
    } catch (err: any) {
  ...
  function handleGoogleLogin() {
    signIn('google', { callbackUrl: '/Event-pass-generator/admin' })
  }
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans selection:bg-blue-200">
      <div className="max-w-md w-full bg-white rounded-3xl p-8 shadow-2xl border border-slate-100">
        ...
        <p className="text-center text-sm text-slate-500 mt-6 font-medium">
          Don't have an account? <Link href="/Event-pass-generator/register" className="text-blue-600 hover:text-blue-700 hover:underline">Sign up for free</Link>
        </p>
