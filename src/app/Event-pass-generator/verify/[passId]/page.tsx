  ...
  if (!visitor) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 text-center">
        ...
        <Link href="/Event-pass-generator" className="px-6 py-3 bg-slate-900 text-white rounded-xl font-bold border border-white/10 hover:bg-slate-800 transition-all">
          Back to Home
        </Link>
      </div>
    )
