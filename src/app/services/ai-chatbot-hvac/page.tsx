...
export const metadata: Metadata = {
    ...
    description: 'Transform your HVAC business with an AI chatbot that answers emergency calls, schedules maintenance, and qualifies leads while you\'re in the field. See why HVAC pros choose AnD AI.',
};
