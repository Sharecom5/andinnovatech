...
const projectsData: Record<string, ProjectDetail> = {
    'ecommerce-platform': {
        ...
        description: 'Global Shopify storefront for Sevya Artisan, connecting fair-trade artisans with a worldwide market through storytelling and optimized UX.',
    ...
    'healthcare-app': {
        ...
        image: '/images/dev_abstract.png',
        description: 'Secure, HIPAA-compliant patient management platform for MedTech Solutions, designed to streamline clinic operations and enhance patient care.',
    ...
    'seo-campaign': {
        ...
        description: 'Multi-region SEO campaign for TechInnovate Ltd that increased organic traffic by 300% within 12 months using technical audits and content growth.',
    ...
    'crm-system': {
        ...
        description: 'Custom CRM solution for RetailHub Inc that centralized relationship management, increasing team productivity and lead conversion rates.',
    ...
    'cloud-migration': {
        ...
        description: 'Enterprise cloud migration for Financial Data Group, moving legacy infrastructure to AWS with zero downtime and 50% cost reduction.',
    ...
    'ramganga-organization': {
        ...
        description: 'Digital hub for Ramganga NGO, a community-focused non-profit platform facilitating online donations and efficient volunteer management.',
    ...
    'kdb-school': {
        ...
        description: 'Comprehensive ERP school management system for KDB Public School, automating attendance, grade tracking, and parent communication.',
    ...
    'sg-lifestyle': {
        ...
        description: 'Sensory digital experience for SG Lifestyle, a high-visual-impact branding site focusing on luxury retail storytelling and user engagement.',
    ...
    'etes-events': {
        ...
        description: 'Industrial-scale event management and exhibition booking platform for ETES, featuring interactive floor-plans and automated vendor onboarding.',
