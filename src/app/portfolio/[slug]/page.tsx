...
const projectsData: Record<string, ProjectDetail> = {
    'ecommerce-platform': {
        ...
        description: 'Discover how we built a global Shopify storefront for Sevya Artisan, connecting traditional fair-trade artisans with a worldwide market through storytelling and optimized UX.',
    ...
    'healthcare-app': {
        ...
        image: '/images/dev_abstract.png',
        description: 'Explore our secure, HIPAA-compliant patient management platform for MedTech Solutions, designed to streamline clinic operations and enhance patient care with real-time data.',
    ...
    'seo-campaign': {
        ...
        description: 'Learn how our multi-region SEO campaign for TechInnovate Ltd increased organic traffic by 300% within 12 months using technical audits and strategic content growth.',
    ...
    'crm-system': {
        ...
        description: 'See how our custom CRM solution for RetailHub Inc centralized relationship management for high-volume operations, increasing team productivity and lead conversion rates.',
    ...
    'cloud-migration': {
        ...
        description: 'Discover our strategic enterprise cloud migration for Financial Data Group, moving legacy on-premise infrastructure to AWS with zero downtime and 50% cost reduction.',
    ...
    'mobile-banking': {
        ...
        description: 'Explore our highly secure and intuitive mobile banking application for NeoBank Finance, featuring biometric login and real-time tracking for digital-first users.',
    ...
    'ramganga-organization': {
        ...
        description: 'See the digital hub we built for Ramganga NGO, a community-focused non-profit platform facilitating online donations and efficient volunteer management to drive impact.',
    ...
    'kdb-school': {
        ...
        description: 'Explore our comprehensive ERP school management system for KDB Public School, automating attendance, grade tracking, and parent communication for 100% digital shift.',
    ...
    'investor-key': {
        ...
        description: 'See our advanced FinTech portal for Investor Key, providing real-time market insights and data visualization for growth-focused financial professionals.',
    ...
    'sg-lifestyle': {
        ...
        description: 'Explore the sensory digital experience we created for SG Lifestyle, a high-visual-impact branding site focusing on luxury retail storytelling and engagement.',
    ...
    'etes-events': {
        ...
        description: 'See our industrial-scale event management and exhibition booking platform for ETES, featuring interactive floor-plans and automated vendor onboarding.',
    ...
    'construction-mirror': {
        ...
        description: 'Explore our B2B marketplace solution for HeavyLink Construction, revolutionizing material procurement and heavy equipment rental with a robust digital architecture.',
