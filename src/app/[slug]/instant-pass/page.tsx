...
import { Ticket, User, Mail, Phone, Building2, Send, Loader2, AlertCircle, Briefcase } from "lucide-react";

export default function InstantPassPage() {
      ...
      <div className="relative z-10 max-w-xl mx-auto pt-20 pb-20 px-6">
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-grey-400 text-sm italic font-medium tracking-tight text-primary-400 mb-1">Instant Pass Generation</p>
            <p className="text-grey-400 text-xs">Fill details to get your unique QR pass immediately.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className={`grid grid-cols-1 ${settings.showDesignation ? 'md:grid-cols-2' : ''} gap-5`}>
              <div>
                <label className="block text-xs font-semibold text-grey-400 uppercase tracking-wider mb-2 px-1">Your Name</label>
                <div className="relative">
            ...
            <p className="text-[10px] text-center text-grey-500 uppercase tracking-widest pt-4">
              Instant Pass Generation Enabled by EntryFlow
            </p>
          </form>
        </motion.div>
      </div>
