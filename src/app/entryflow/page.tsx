    ...
    <div className="min-h-screen bg-[#FAFAFA] text-slate-900 font-sans selection:bg-indigo-200 overflow-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 py-4 sm:px-12 flex justify-between items-center bg-white/60 backdrop-blur-xl border-b border-white/20 shadow-[0_4px_30px_rgba(0,0,0,0.03)] supports-[backdrop-filter]:bg-white/40">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
          ...
          <Link href="/entryflow/login" className="hover:text-indigo-600 transition-colors">Sign In</Link>
          <Link href="/entryflow/register" className="bg-slate-900 text-white px-5 py-2.5 rounded-full hover:bg-slate-800 transition-all shadow-md hover:shadow-xl hover:-translate-y-0.5 transform duration-200">
            Get Started Free
          </Link>
        </div>
      </nav>
      ...
      <section className="relative pt-32 pb-20 lg:pt-52 lg:pb-32 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in slide-in-from-bottom-12 fade-in duration-700">
            <Link href="/entryflow/register" className="w-full sm:w-auto px-8 py-4 rounded-full bg-slate-900 text-white font-bold text-lg hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/20 hover:shadow-2xl hover:shadow-slate-900/40 flex items-center justify-center gap-2 group hover:-translate-y-0.5">
              Start Free Trial
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/entryflow/login" className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/80 backdrop-blur-sm text-slate-700 font-bold text-lg border border-slate-200/60 hover:bg-white hover:border-slate-300 transition-all shadow-sm hover:shadow-md">
              View Demo
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto pt-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-center">
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/10 shadow-2xl flex flex-col">
              ...
              <Link href="/entryflow/register" className="w-full py-4 text-center rounded-2xl bg-white/10 text-white font-bold hover:bg-white/20 transition-colors border border-white/5">Start for Free</Link>
            </div>
            ...
            <div className="relative bg-white rounded-[2.5rem] p-8 shadow-2xl shadow-indigo-500/20 flex flex-col transform md:-translate-y-4">
              ...
              <Link href="/entryflow/register" className="w-full py-4 text-center rounded-2xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:-translate-y-0.5 duration-200">Get Pro</Link>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/10 shadow-2xl flex flex-col">
              ...
              <Link href="/entryflow/register" className="w-full py-4 text-center rounded-2xl bg-white/10 text-white font-bold hover:bg-white/20 transition-colors border border-white/5">Contact Sales</Link>
            </div>
          </div>
        </div>
      </section>
